...
const translations: Translations = {
  ...
  'lgbm.numLeaves': { en: 'Number of Leaves', fr: 'Nombre de Feuilles' },
  'lgbm.numLeaves.desc': { en: 'More leaves = more complex trees, but also more risk of overfitting', fr: 'Plus de feuilles = arbres plus complexes, mais aussi plus de risque de surapprentissage' },
  'lgbm.step1.title': { en: 'Leaf-wise Tree Growth', fr: 'Croissance d\'Arbre Feuille par Feuille' },
  'lgbm.step1.desc': { en: 'Unlike level-wise growth, LightGBM grows trees leaf-wise, choosing the leaf with the largest loss reduction', fr: 'Contrairement à la croissance niveau par niveau, LightGBM fait pousser les arbres feuille par feuille, en choisissant la feuille avec la plus grande réduction de perte' },
  'lgbm.step2.title': { en: 'Gradient-based One-Side Sampling (GOSS)', fr: 'Échantillonnage Unilatéral Basé sur le Gradient (GOSS)' },
  'lgbm.step2.desc': { en: 'Keeps instances with large gradients and randomly samples instances with small gradients for efficiency', fr: 'Garde les instances avec de grands gradients et échantillonne aléatoirement les instances avec de petits gradients pour l\'efficacité' },
  'lgbm.step3.title': { en: 'Exclusive Feature Bundling (EFB)', fr: 'Regroupement de Caractéristiques Exclusives (EFB)' },
  'lgbm.step3.desc': { en: 'Bundles mutually exclusive features to reduce the number of features and speed up training', fr: 'Regroupe les caractéristiques mutuellement exclusives pour réduire le nombre de caractéristiques et accélérer l\'entraînement' },
  'lgbm.comparison.title': { en: 'Leaf-wise vs Level-wise Growth', fr: 'Croissance Feuille par Feuille vs Niveau par Niveau' },
  'lgbm.comparison.level': { en: 'Level-wise (Traditional)', fr: 'Niveau par Niveau (Traditionnel)' },
  'lgbm.comparison.level.desc': { en: 'Grows all nodes at the same level', fr: 'Fait pousser tous les nœuds au même niveau' },
  'lgbm.comparison.leaf': { en: 'Leaf-wise (LightGBM)', fr: 'Feuille par Feuille (LightGBM)' },
  'lgbm.comparison.leaf.desc': { en: 'Grows the leaf with largest loss reduction', fr: 'Fait pousser la feuille avec la plus grande réduction de perte' },
  'lgbm.goss.title': { en: 'Gradient-based One-Side Sampling', fr: 'Échantillonnage Unilatéral Basé sur le Gradient' },
  'lgbm.goss.points': { en: 'Data Points by Gradient Size', fr: 'Points de Données par Taille de Gradient' },
  'lgbm.goss.large': { en: 'Large gradient - Always kept', fr: 'Grand gradient - Toujours gardé' },
  'lgbm.goss.medium': { en: 'Medium gradient - Kept with probability', fr: 'Gradient moyen - Gardé avec probabilité' },
  'lgbm.goss.small': { en: 'Small gradient - Randomly sampled', fr: 'Petit gradient - Échantillonné aléatoirement' },
  'lgbm.efb.title': { en: 'Exclusive Feature Bundling', fr: 'Regroupement de Caractéristiques Exclusives' },
  'lgbm.efb.before': { en: 'Before Bundling', fr: 'Avant le Regroupement' },
  'lgbm.efb.after': { en: 'After Bundling', fr: 'Après le Regroupement' },
  'lgbm.efb.desc': { en: 'Mutually exclusive features are bundled together, reducing feature count and speeding up training', fr: 'Les caractéristiques mutuellement exclusives sont regroupées ensemble, réduisant le nombre de caractéristiques et accélérant l\'entraînement' },
